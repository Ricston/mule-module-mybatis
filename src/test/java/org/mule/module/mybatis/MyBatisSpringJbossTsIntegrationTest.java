...
public class MyBatisSpringJbossTsIntegrationTest extends FunctionalTestCase{
	
	public MyBatisSpringJbossTsIntegrationTest(){
		super();
	...
	protected String getConfigResources() {
		return "mybatis-common-test.xml, mybatis-spring-jbossts-integration-test.xml";
	}
